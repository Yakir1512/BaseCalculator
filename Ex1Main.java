...
public class Ex1Main {
    public static void main(String[] args) {
        ...
        while (!num1.equals(quit) && !num2.equals(quit)) {                   //loop in cases of user want to quit, enter wrong num or want to start again.
            ...
            if (!num1.equals("quit")) {
                if(Ex10.isNumber(num1))                     //check if number is valid
                ...
                if (!num2.equals("quit")){
                    if (Ex10.isNumber(num2)){               //check if number is valid
                        ...
                        if (!(stbase.length() > 1))                        //convert the base to int.
                            base = Ex10.inputBase(stbase); //
                        else {                                             //if the input base isnt valid.
                            System.out.println("Base is not valid to me!!!" + " Try again");
                            continue;
                        }
                        base1 = Ex10.theNumberBase(num1);       //Converting String to Int
                        base2 = Ex10.theNumberBase(num2);       //SAME!^
                        ...
                        System.out.println("the first converted number is - "+num1+" in base "+base1+ " and it converted to: "+ Ex10.converToBase(Ex10.converToTen(num1,base1),base));
                        System.out.println("the second converted number is -"+num2+" in base "+base2+" and it converted to: "+ Ex10.converToBase(Ex10.converToTen(num2,base2),base));
                        System.out.println("Max index in-"+ num1+" is: "+ Ex10.maxIndex(str));
                        System.out.println("Max index in-"+ num2+" is: "+ Ex10.maxIndex(str2));
                        System.out.println("are equals? "+ Ex10.equals(number,number2));
                    }
                    else{
